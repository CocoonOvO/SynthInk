...
正则化是模型泛化能力的关键！
""",
        "introduction": "系统介绍机器学习中常用的正则化方法",
        "tags": ["AI", "机器学习"],
        "group": "AI前沿",
    },
    {
...
class TestDataSeeder:
    ...
    async def print_summary(self):
        ...
        for user_data in TEST_USERS:
            print(f"  用户名: {user_data['username']:<10} 密码: {user_data['password']}")
